...
import classes from './searchservices.module.scss';

import ServicesItem from '../ServicesItem/ServicesItem';

const SearchServices = ({ search, services, modalService, linksSection }) => {
					...
					>
						...
						<Scrollbars
							style={{ height: '436px'}}
									...
									>
							{cleanServices.length !== 0 ? cleanServices : <p className={classes.notfound}>Service not found!</p>}
						</Scrollbars>
